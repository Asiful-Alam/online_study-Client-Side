  ...
  return (
    <div className="container max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
      ...
      <div>
        ...
        />
        <div className="mt-4">
          <span className="text-lg text-red-400">Brand Name:</span>
          <p className="text-sm font-semibold">{assignment.brandName}</p>
        </div>
        <div className="mt-2">
          <span className="text-lg text-red-400">Price:</span>
          <p className="text-sm font-semibold">${assignment.price}</p>
        </div>
        <div className="mt-2">
